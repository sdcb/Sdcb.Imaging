...
namespace Sdcb.Imaging
{
    public static class WatermarkTool
    {
        ...
        public static void AddWatermark(Stream imageStream, Stream outputStream, string watermark, string font = "微软雅黑", float fontSize = 30.0f, int colorARGB = TransparentWhite)
        {
